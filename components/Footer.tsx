const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-primary-900/10 to-accent-900/10 dark:from-primary-800/20 dark:to-accent-800/20"></div>
          ...
          <div className="flex space-x-4">
            {socialLinks.map((link, index) => (
              <a
                ...
                className="group bg-white/10 dark:bg-gray-800/20 backdrop-blur-sm hover:bg-white/20 dark:hover:bg-gray-700/30 text-gray-300 dark:text-gray-400 hover:text-white p-3 rounded-xl border border-white/10 dark:border-gray-700/20 hover:border-white/20 dark:hover:border-gray-600/30 transition-all duration-300 transform hover:scale-110 hover:shadow-glow"
