...
const UserPortfolioFooter = () => {
  ...
  return (
    <footer className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border-t border-gray-200/20 dark:border-gray-700/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
              Personal portfolio showcasing skills, projects, and professional
              experience. Built with modern web technologies and best practices.
            </p>
        ...
        <div className="border-t border-gray-200/20 dark:border-gray-700/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              © 2024 User Portfolio. All rights reserved.
            </p>
